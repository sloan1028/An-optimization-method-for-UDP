...
class Gamer final :
 ...
 public:
  ...
  // repeated .tutorial.Person_State people = 1;
  int people_size() const;
  private:
  int _internal_people_size() const;
  public:
  void clear_people();
  ::tutorial::Person_State* mutable_people(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tutorial::Person_State >*
      mutable_people();
  private:
  const ::tutorial::Person_State& _internal_people(int index) const;
  ::tutorial::Person_State* _internal_add_people();
  public:
  const ::tutorial::Person_State& people(int index) const;
  ::tutorial::Person_State* add_people();
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tutorial::Person_State > people_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_addressbook_2eproto;
};
// ===================================================================
...
// repeated .tutorial.Person_State people = 1;
inline int Gamer::_internal_people_size() const {
  return people_.size();
}
inline int Gamer::people_size() const {
  return _internal_people_size();
}
inline void Gamer::clear_people() {
  people_.Clear();
}
inline ::tutorial::Person_State* Gamer::mutable_people(int index) {
  // @@protoc_insertion_point(field_mutable:tutorial.Gamer.people)
  return people_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tutorial::Person_State >*
Gamer::mutable_people() {
  // @@protoc_insertion_point(field_mutable_list:tutorial.Gamer.people)
  return &people_;
}
inline const ::tutorial::Person_State& Gamer::_internal_people(int index) const {
  return people_.Get(index);
}
inline const ::tutorial::Person_State& Gamer::people(int index) const {
  // @@protoc_insertion_point(field_get:tutorial.Gamer.people)
  return _internal_people(index);
}
inline ::tutorial::Person_State* Gamer::_internal_add_people() {
  return people_.Add();
}
inline ::tutorial::Person_State* Gamer::add_people() {
  ::tutorial::Person_State* _add = _internal_add_people();
  // @@protoc_insertion_point(field_add:tutorial.Gamer.people)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tutorial::Person_State >&
Gamer::people() const {
  // @@protoc_insertion_point(field_list:tutorial.Gamer.people)
  return people_;
}
